...
export function GlobalLoadingProvider({ children }: { children: React.ReactNode }) {
  ...
  const stopPending = React.useCallback(() => {
  ...
  const value = React.useMemo<GlobalLoadingContextValue>(
    () => ({
    ...
    [navigationActive, pendingCount, startNavigation, stopNavigation, startPending, stopPending],
  );
