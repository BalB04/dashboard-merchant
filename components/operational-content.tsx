    ...
    <div className="space-y-4 px-3 py-3 md:px-5">
      <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        <div className="flex items-start justify-between gap-3">
          <div className="text-[1.85rem] font-bold tracking-[-0.035em] leading-tight text-slate-900">
            Operasional
          </div>
          <div className="rounded-md bg-red-600 px-2.5 py-1 text-xs font-semibold text-white">
            Merchant
          </div>
        </div>
      </div>
      ...
      <div
        id="trend"
        className={`rounded-xl border bg-white p-4 shadow-sm ${highlightedSection === "trend" ? "border-blue-500" : "border-slate-200"}`}
      >
        <div className="mb-2 text-[1.05rem] font-bold tracking-[-0.02em] text-slate-900">
        ...
        <div className="grid gap-3 lg:grid-cols-2">
          <div className="rounded-lg border border-slate-200 p-3">
            ...
            <div className="mt-1 text-[1.7rem] font-bold tracking-[-0.04em] leading-none text-slate-900">
              {fmt(data.transactionStatus.success)}
            </div>
          </div>
          <div className="rounded-lg border border-slate-200 p-3">
            <div className="text-[11px] font-bold uppercase tracking-[0.22em] text-slate-500">
            ...
            <div className="mt-1 text-[1.7rem] font-bold tracking-[-0.04em] leading-none text-slate-900">
              {fmt(data.transactionStatus.failed)}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-3 xl:grid-cols-2">
        <div
          id="rules"
          className={`glass-panel content-fade-in rounded-[20px] border p-5 shadow-sm ${highlightedSection === "rules" ? "border-blue-500" : "border-slate-200"}`}
        >
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-2 text-[1.05rem] font-bold tracking-[-0.02em] text-slate-900">
              <span className="flex h-9 w-9 items-center justify-center rounded-2xl bg-rose-50 text-red-700">
                <Link2 className="h-4 w-4" />
              </span>
              <span>My Keywords Status</span>
            </div>
          </div>
      ...
      <div
        id="transactions"
        className={`glass-panel content-fade-in rounded-[20px] border p-5 shadow-sm ${highlightedSection === "transactions" ? "border-blue-500" : "border-slate-200"}`}
      >
        <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
          <div>
            <div className="flex items-center gap-2 text-[1.15rem] font-bold tracking-[-0.03em] leading-tight text-slate-900">
              <span className="flex h-9 w-9 items-center justify-center rounded-2xl bg-rose-50 text-red-700">
            ...
            <div className="mt-1 text-xs font-medium leading-5 text-slate-500">
              Cari dan telusuri transaksi merchant
            </div>
          </div>
        </div>
        ...
        <div className="mt-3 flex items-center justify-between text-xs text-slate-500">
          <span>
            Menampilkan {pageRows.length} dari {filteredRows.length}
          </span>
